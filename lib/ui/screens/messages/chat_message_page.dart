...
import 'package:tawari/domain/models/response/response_list_messages.dart';
import 'package:tawari/domain/services/chat_services.dart';
import 'package:tawari/ui/screens/messages/widgets/chat_message.dart';
          ...
          BlocBuilder<ChatBloc, ChatState>(
            builder: (_, state) => TextButton(
                onPressed: state.isWritting
                    ...
                    : null,
                child:
                    const TextCustom(text: 'Send', color: ColorsTbd.primary)),
          )
        ],
      ),
    );
